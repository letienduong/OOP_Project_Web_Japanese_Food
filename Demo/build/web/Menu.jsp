...
<header>
    ...
    <li class="manager">
        <a href="admin.jsp"><i class="fas fa-cog"></i></a> <!-- Liên kết đến trang quản lý -->
    </li>
     </c:if>
        <!-- Dropdown -->
        <li class="dropdown">
            ...
            <c:if test="${sessionScope.acc != null}">
            <a class="user" href="ProfileServlet"><i class="fas fa-user"></i></a> <!-- Chuyển đến signup.jsp khi click -->
            </c:if>
        ...
        <!-- Shopping cart -->
        <li><a class="giohang" href="cart.jsp"><i class="fas fa-shopping-cart"></i></a></li>
    </div>
</header>
